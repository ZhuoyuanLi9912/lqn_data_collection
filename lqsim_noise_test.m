    ...
    T1 = Task(model, 'Client1', 20, SchedStrategy.REF).on(P1);
    E1 = Entry(model, 'Browse1').on(T1);
    T2 = Task(model, 'Client2', 20, SchedStrategy.REF).on(P1);
    E2 = Entry(model, 'Browse2').on(T2);
    T3 = Task(model, 'Client3', 20, SchedStrategy.REF).on(P1);
    ...
    T5 = Task(model, 'FrontEnd', 10, SchedStrategy.FCFS).on(P3);
    ...
    T6 = Task(model, 'Cart', 10, SchedStrategy.FCFS).on(P4);
    ...
    A6 = Activity(model, 'A6', Exp.fitMean(0.1)).on(T4).synchCall(E6,0.5).repliesTo(E4);
    A7 = Activity(model, 'A7', Exp.fitMean(0.1)).on(T4).synchCall(E7,0.5).repliesTo(E4);
    ...
    A10 = Activity(model, 'A10', Exp.fitMean(0.1)).on(T5).synchCall(E8,3).repliesTo(E6);
    A11 = Activity(model, 'A11', Exp.fitMean(0.1)).on(T5).synchCall(E9,3).repliesTo(E6);
    A12 = Activity(model, 'A12', Exp.fitMean(0.1)).on(T5).synchCall(E10,3).repliesTo(E6);
    ...
    A14 = Activity(model, 'A14', Exp.fitMean(0.1)).on(T5).synchCall(E11,0.3).repliesTo(E7);
    A15 = Activity(model, 'A15', Exp.fitMean(0.1)).on(T5).synchCall(E12,0.3).repliesTo(E7);
